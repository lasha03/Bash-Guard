...
def test_precision_of_parameters():
    ...
    assert vulnerabilities[3].vulnerability_type == VulnerabilityType.COMMAND_INJECTION
    assert vulnerabilities[4].vulnerability_type == VulnerabilityType.VARIABLE_EXPANSION
